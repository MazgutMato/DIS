...
namespace DIS.Models.AgentSimulation.STKSimulation.simulation
{
    public class SimId : IdList
    {
		...
		public const int AgentSTK = 3;
		public const int AgentAutomechanici = 4;
		public const int AgentTechnici = 6;
		public const int ManagerModelu = 101;
		public const int ManagerOkolia = 102;
		public const int ManagerSTK = 103;
		public const int ManagerAutomechanici = 104;
		public const int ManagerTechnici = 106;
		...
		public const int PrestavkaTechnici = 1008;
		public const int PrestavkaAutomechanici = 1009;
		public const int ProcessPlatenia = 1007;
		//meta! tag="end"
    }
}